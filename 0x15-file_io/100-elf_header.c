...
/**
 * check_elf - check file is an ELF file.
...
/**
 * print_magic - out puts  the magic numbers of an ELF header.
 * @e_ident: array containing the ELF magic numbers.
 *
...
/**
 * print_osabi - output OS/ABI of an ELF header.
 * @e_ident: array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
 ...
 *
 * Description: the file cannot be closed? - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - outputs information contained in
